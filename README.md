...
```
posix-yq/
├── cmd/generator/          # Go generator source code
│   └── main.go            # Main entry point
├── pkg/generator/          # Generator packages
│   ├── yaml_reader.go     # YAML file reading logic
│   ├── query_parser.go    # Query parsing logic
│   ├── key_extractor.go   # Key extraction logic
│   └── json_formatter.go  # JSON formatting logic
...
| `make test-unit-generator` | Run Go unit tests |
| `make test-unit-posix-yq` | Run posix-yq script unit tests (placeholder) |
